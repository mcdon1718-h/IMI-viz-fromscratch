...
registerDataset({
  ...
  name:     'Contiguous USA',
  dataRoot: DATA_ROOT,
  description: 'Annual contiguous US emissions and trends for 2019-2024 at 25-km resolution generated by the IMI using TROPOMI satellite data combined with bottom-up information from the Greenhouse Gas Inventory (GHGI). See  Estrada et al. (2026) for details.',
  /*
