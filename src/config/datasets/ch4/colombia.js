...
registerDataset({
  ...
  name:     'Colombia',
  dataRoot: DATA_ROOT,
  description: 'Annual Colombia emissions and trends for 2019-2024 at 12-km resolution generated by the IMI using TROPOMI satellite data combined with bottom-up information from the spatially resolved BTR inventory. See Hancock et al. (2026) for details.',
  /*
